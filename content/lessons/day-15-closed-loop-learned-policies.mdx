...
6. **Then** add free closed-loop learned multi-contact that chooses ranking / soft refs above the QP — never replace cones, FOC, `torque_scale`, gait, recovery, or measured `ContactState`. Teleop / shared-autonomy arbitration under the same ceilings continues in [Day 16](/lessons/day-16-teleop-shared-autonomy).
