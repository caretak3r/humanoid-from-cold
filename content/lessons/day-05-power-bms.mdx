...
flowchart TD
  ...
  Class -->|Soft sag / warm / low SOC| Derate[Derate: torque_scale &lt; 1<br/>or max |iq| limit]
...
| Derate | Stay upright with less muscle | Scale max $|i_q|$ as $V_{\text{bus}}$ approaches soft limit |
