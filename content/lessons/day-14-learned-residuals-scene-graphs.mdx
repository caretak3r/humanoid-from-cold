...
6. **Then** add free residual / scene-driven schedules that choose ranking / soft refs above the QP — never replace cones, FOC, `torque_scale`, gait, recovery, or measured `ContactState`. Closed-loop learned policies under measured ceilings and sim-to-real residual validation continue in [Day 15](/lessons/day-15-closed-loop-learned-policies).
